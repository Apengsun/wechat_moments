...
public interface RouterHub {
    ...
    String LOG = "/loginregister";//登录注册 组件
     ...
     * 宿主 App 分组
     */
    String APP_WE_CHAT_ACTIVITY = APP + "/WeChatActivity";


    /**
     * 登录注册忘记密码
     */
    String LOG_LOGIN_ACTIVITY = LOG + "/LoginActivity";
