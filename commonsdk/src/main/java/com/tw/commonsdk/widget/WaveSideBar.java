...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColor = Color.parseColor("#FF634C00");
        mWaveColor = Color.parseColor("#FFFFF4D8");
        mTextColorChoose = ContextCompat.getColor(context, android.R.color.white);
        mTextSize = context.getResources().getDimensionPixelSize(12);
        mHintTextSize = context.getResources().getDimensionPixelSize(24);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.dp_15);
        if (attrs != null) {
