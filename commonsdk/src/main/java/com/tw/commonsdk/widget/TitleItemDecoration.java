...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int TITLE_BG_COLOR = Color.parseColor("#F5F5F5");
    private static int TITLE_TEXT_COLOR = Color.parseColor("#999999");
    ...
    public TitleItemDecoration(Context context, List<SortModel> data) {
        ...
        mTitleTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 13, context.getResources().getDisplayMetrics());
        leftPading = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, context.getResources().getDisplayMetrics());
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position > -1) {
                if (position == 0) {//等于0的时候绘制title
                    ...
                    if (!TextUtils.isEmpty(mData.get(position).getLetters()) && !mData.get(position)
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position > -1) {
            ...
            if (position == 0) {
                ...
                if (!TextUtils.isEmpty(mData.get(position).getLetters()) &&
