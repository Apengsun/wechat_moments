...
import com.tw.commonsdk.okgo.ErrorBean;
import com.tw.commonsdk.okgo.response.LzyResponse;
import com.tw.commonsdk.okgo.response.SimpleResponse;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    public T convertResponse(Response response) throws Throwable {
        ...
        try {
            ...
            errorBean = Convert.fromJson(buffer.clone().readString(UTF8), ErrorBean.class);
            //            if (errorBean != null && !TextUtils.isEmpty(errorBean.getMessage())) {
            //适配云链接口
            if (errorBean != null && !TextUtils.isEmpty(errorBean.getMessage()) && !"请求成功".equals(errorBean.getMessage())) {
