...
public class NavigationUtils {
    ...
    public static void navigation(Context context, String path, String key, String value) {
        ARouter.getInstance().build(path).withString(key, value).navigation(context);
    }

    public static void navigation(Context context, String path, @Nullable String key, @Nullable ArrayList<?
    ...
    public static void navigation(Context context, String path, String key, Bundle value) {
        ARouter.getInstance().build(path).withBundle(key, value).navigation(context);
    }
     ...
     * @param path
     */
    public static void navigationGreen(Context context, String path) {
        ARouter.getInstance().build(path).greenChannel().navigation(context);
    }
