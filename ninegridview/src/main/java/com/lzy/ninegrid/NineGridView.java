...
public class NineGridView extends ViewGroup {
    ...
    public NineGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        singleImageSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                singleImageSize, dm);
        ...
        singleImageSize = a.getDimensionPixelSize(R.styleable.NineGridView_ngv_singleImageSize,
                singleImageSize);
        singleImageRatio = a.getFloat(R.styleable.NineGridView_ngv_singleImageRatio,
                singleImageRatio);
...
//        int width = MeasureSpec.getSize(widthMeasureSpec);
        int width = DisplayUtils.getScreenMetricsWidth(getContext())-DisplayUtils.dip2px(getContext(),73);
        int height = 0;
        ...
        if (mImageInfo != null && mImageInfo.size() > 0) {
            if (mImageInfo.size() == 1) {
                ...
                gridWidth = gridHeight =
                        (totalWidth - gridSpacing * (columnCount - 1)) / columnCount;
                if (columnCount == 2) {
                    gridWidth = gridHeight = (totalWidth - gridSpacing * 2) / 3;
                }
                Log.e("$$$$$", "totalWidth=" + totalWidth + "   gridSpacing=" + gridSpacing + "  " +
            ...
            height =
                    gridHeight * rowCount + gridSpacing * (rowCount - 1) + getPaddingTop() + getPaddingBottom();
        }
        ...
        if (mImageInfo == null) {
            ...
            if (oldViewCount > newViewCount) {
                ...
                for (int i = oldViewCount; i < newViewCount; i++) {
                    ...
                    if (iv == null)
                        return;
                    addView(iv, new LayoutParams(LayoutParams.MATCH_PARENT,
        ...
        if (position < imageViews.size()) {
            ...
            imageView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mAdapter.onImageItemClick(getContext(), NineGridView.this, position,
