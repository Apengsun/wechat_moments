...
package com.tw.commonres.widget;
...
public class LoadingLayout extends FrameLayout {
    ...
    int mEmptyImage;
    CharSequence mEmptyText,mEmptyBtnText;
    ...
    View.OnClickListener mEmptyButtonClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if (mEmptyListener != null) {
                mEmptyListener.onClick(v);
            }
        }
    };
    View.OnClickListener mEmptyListener;
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyBtnText = a.getString(R.styleable.LoadingLayout_llEmptyBtnText);
    ...
    public LoadingLayout setEmptyBtnText(String text) {
        mEmptyBtnText = text;
        text(mEmptyResId, R.id.empty_button, mEmptyBtnText);
        return this;
    }
    ...
    public LoadingLayout setEmptyListener(OnClickListener listener) {
...
//    }
    ...
    private View layout(int layoutId) {
        ...
        if (layoutId == mEmptyResId) {
            ...
            TextView btn = (TextView) layout.findViewById(R.id.empty_button);
            if (btn != null) {
                btn.setText(mEmptyBtnText);
                ...
                btn.setOnClickListener(mEmptyButtonClickListener);
            }
